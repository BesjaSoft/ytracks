<div class="view">
	...
	<?php echo CHtml::encode($data->circuit_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('distance_id')); ?>:</b>
	<?php echo CHtml::encode($data->distance_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('manches')); ?>:</b>
	<?php echo CHtml::encode($data->manches); ?>
	<br />
