...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'acronym',array('size'=>6,'maxlength'=>6)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'picture_small'); ?>
		<?php echo $form->textField($model,'picture_small',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'picture_small'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'country_code'); ?>
		<?php echo $form->textField($model,'country_code',array('size'=>3,'maxlength'=>3)); ?>
