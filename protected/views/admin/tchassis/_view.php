<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('tmake')); ?>:</b>
	<?php echo CHtml::encode($data->tmake); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('chassis')); ?>:</b>
	<?php echo CHtml::encode($data->chassis); ?>
	<br />
