...
$attributes[] = array('name' => 'tuner_id', 'type' => 'raw', 'value' => isset($model->tuner_id) ? CHtml::Link(CHtml::encode($model->tuner->name), array('tuner/view', 'id' => $model->tuner_id)) : $model->tuner_id);
