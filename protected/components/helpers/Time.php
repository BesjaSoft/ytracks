...
class Time {
    ...
    public static function nice($dateString = null, $format = 'F d, o') {
        ...
        $date = ($dateString == null) ? time() : new DateTime($dateString, new DateTimeZone('Europe/Amsterdam'));
    ...
    public static function wasYesterday($date) {
        return date('Y-m-d', $date) == date('Y-m-d', new DateTime('yesterday', new DateTimeZone('Europe/Amsterdam')));
    }
    ...
    function timeAgoInWords($dateTime, $options = array()) {
        ...
        $inSeconds = new DateTime($dateTime, new DateTimeZone('Europe/Amsterdam'));
        ...
        if ($diff > abs($now - new DateTime($end, new DateTimeZone('Europe/Amsterdam')))) {
