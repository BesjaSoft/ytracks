...
class Multithumb {
    ...
    private static $_jpath_site = '../rpd/';
    private static $_live_site  = '../rpd/';
    private static $imagePath = '../../images/stories/';
    private static $thumbPath = '../rpd/plugins/content/multithumb/thumbs/';
/*
    private function _plgContentMultithumb ( &$subject ) {
 ...
 width: auto;
   ...
   return true;
    ...
    public static function createThumbnail($filename, $width=120, $height=80, $proportion='bestfit', $bgcolor = 0xFFFFFF, $watermarkfile = '') {
        ...
        global $mainframe, $botMtGlobals, $multithumb_msg;
    ...
    **/
    ...
    function botAddMultiThumbHeader($headertype) {
       global $mainframe, $cur_template, $botMtGlobals;
    ...
    function bot_mt_image_replacer(&$matches) {
       ...
       if($resize || $watermark) {
          $imgtemp = self::createThumbnail($imgloc, 'images', $full_width, $full_height, $image_proportions, hexdec($image_bg), $watermark_file);
