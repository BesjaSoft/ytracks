...
class VehicleController extends BaseController
{
    ...
    public function accessRules()
    {
        return array(
            array('allow',  // allow all users to perform 'index' and 'view' actions
                'actions'=>array('index','view','getVehicles'),
                'users'=>array('*'),
            ),
    ...
    public function actionGetVehicles()
    {
        ...
        $data=Vehicle::model()->list()->findAll('type_id=:type_id',
                      array(':type_id'=>(int) $result['type_id']));
    ...
    public function actionIndex()
    {
        ...
        if(isset($_GET['type_id'])){
            $dataProvider=new CActiveDataProvider('Vehicle',array('criteria'=>array('condition'=>'type_id='.$_GET['type_id'])));
        } else{
    ...
    public function loadModel()
    {
        if ($this->_model===null) {
            if(isset($_GET['id'])) {
                $this->_model=Vehicle::model()->findbyPk($_GET['id']);
            }
            if($this->_model===null) {
