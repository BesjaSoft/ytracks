...
class IndividualReference extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            array('source_id, source_reference, gender, createdon', 'required'),
            ...
            array('source_id+source_reference', 'uniqueMultiColumnValidator', 'caseSensitive' => 'true'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, individual_id, source_id, source_reference, full_name, first_name, last_name, createdon, modifiedon, deleted, deletedon',
                'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            ...
            'source' => array(self::BELONGS_TO, 'Weblink', 'source_id'),
        );
    }
