...
class Result extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            ...
            // unique key check:
            array('individual_id+team_id+subround_id+rank', 'uniqueMultiColumnValidator', 'caseSensitive' => true),
    ...
    public function beforeValidate() {
        ...
        if (empty($this->raceclass_id)) {
            $this->raceclass_id = null;
        }
        if (empty($this->tresult_id)) {
            $this->tresult_id = null;
        }
        if (empty($this->vehicle_id)) {
            $this->vehicle_id = null;
        }
        if (empty($this->tyre_id)) {
            $this->tyre_id = null;
        }
